...
export default function Security({
    ...
    return (
        <>
            <Head title={t('settings.security.settingsTitle')} />

            <h1 className="sr-only">{t('settings.security.settingsTitle')}</h1>

            <div className="space-y-6">
                <Heading
                    variant="small"
                    title={t('settings.security.password.updatePassword')}
                    ...
                    {twoFactorEnabled ? (
                        <div className="flex flex-col items-start justify-start space-y-4">
                            <p className="text-sm text-muted-foreground">
                                {t(
                                    'settings.security.twoFactor.enabledDescription',
                                )}
                            </p>
                        ...
                        <div className="flex flex-col items-start justify-start space-y-4">
                            <p className="text-sm text-muted-foreground">
                                {t(
                                    'settings.security.twoFactor.disabledDescription',
                                )}
                            </p>
                            ...
                            <div>
                                {hasSetupData ? (
                                    ...
                                    >
                                        <ShieldCheck />
                                        {t(
                                            'settings.security.twoFactor.continueSetup',
                                        )}
                                    </Button>
                                ) : (
                                    <Form
...
Security.layout = (props: PageProps) => {
    const t = createTranslator(props.translations as TranslationObject);

    return {
        breadcrumbs: [
            {
                title: t('settings.security.settingsTitle'),
                href: edit(),
            },
        ],
    };
